...
class Solution {
    public int[] nextGreaterElement(int[] nums1, int[] nums2) {
        //create a hashmap to map a number and the next greatest to the right in big array.
        HashMap<Integer, Integer> next_greatest = new HashMap<>();
        Stack<Integer> stack = new Stack<>();
        
        for(int i = 0; i<nums2.length; i++){
            //this needs to be while loop to find next greates, 
            //if used if condition, the next one might not be the next greatest.
        ...
        //loop through smaller array and 
